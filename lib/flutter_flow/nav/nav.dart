...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: EditProfilPageWidget.routeName,
          path: EditProfilPageWidget.routePath,
          builder: (context, params) => EditProfilPageWidget(),
        ),
        FFRoute(
          name: PerformancePageWidget.routeName,
          path: PerformancePageWidget.routePath,
          builder: (context, params) => PerformancePageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: EditProfilDogPageWidget.routeName,
          path: EditProfilDogPageWidget.routePath,
          builder: (context, params) => EditProfilDogPageWidget(
            dogParameter: params.getParam(
              'dogParameter',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['users', 'dog'],
            ),
          ),
        ),
        FFRoute(
          name: DogsPageWidget.routeName,
          path: DogsPageWidget.routePath,
          builder: (context, params) => DogsPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CreateProfilDogPageWidget.routeName,
          path: CreateProfilDogPageWidget.routePath,
          builder: (context, params) => CreateProfilDogPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ChatViewPageWidget.routeName,
          path: ChatViewPageWidget.routePath,
          builder: (context, params) => ChatViewPageWidget(
            chatParameter: params.getParam(
              'chatParameter',
              ParamType.DocumentReference,
              isList: false,
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/WhatsApp_Image_2025-05-20__16.47.42_25c0b81a.jpg',
