...
import 'dog_component_model.dart';
export 'dog_component_model.dart';

class DogComponentWidget extends StatefulWidget {
  const DogComponentWidget({
    super.key,
  ...
  @override
  State<DogComponentWidget> createState() => _DogComponentWidgetState();
}

class _DogComponentWidgetState extends State<DogComponentWidget> {
  late DogComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DogComponentModel());
  }
