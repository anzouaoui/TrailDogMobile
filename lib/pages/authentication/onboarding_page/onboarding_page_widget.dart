                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'hz31u204' /* Move with your dog like never ... */,
                                          ),
                                  ...
                                  child: Material(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '0nq0xefy' /* Track your performance and the... */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .headlineSmall
                                    ...
                                    child: Material(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              's1z3azwk' /* Join a passionate community an... */,
                                            ),
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .headlineSmall
