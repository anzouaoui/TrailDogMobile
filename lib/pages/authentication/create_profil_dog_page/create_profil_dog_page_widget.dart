...
export 'create_profil_dog_page_model.dart';

class CreateProfilDogPageWidget extends StatefulWidget {
  const CreateProfilDogPageWidget({super.key});

  static String routeName = 'CreateProfilDogPage';
  static String routePath = '/createProfilDogPage';

  @override
  State<CreateProfilDogPageWidget> createState() =>
      _CreateProfilDogPageWidgetState();
}

class _CreateProfilDogPageWidgetState extends State<CreateProfilDogPageWidget> {
  late CreateProfilDogPageModel _model;
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              width: double.infinity,
                              child: TextFormField(
                                controller: _model.textFieldAgeTextController,
                          ...
                          children: [
                            ...
                            FlutterFlowDropDown<String>(
                              ...
                              options: [
                                ...
                                FFLocalizations.of(context).getText(
                                  'gle1ddiu' /* Intermediate */,
                                ),
                                FFLocalizations.of(context).getText(
                                  'qfftgfu9' /* Advanced */,
                                ),
                                FFLocalizations.of(context).getText(
                                  'y0ycb13w' /* Professional */,
                                )
                              ],
                              onChanged: (val) => safeSetState(
