                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() => _model
                                              .isDataUploading_profileUploaded =
                                          true);
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_profileUploaded =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                              selectedMedia.length &&
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_profileUploaded =
                                              selectedUploadedFiles.first;
                                          _model.uploadedFileUrl_profileUploaded =
                                              downloadUrls.first;
                                        });
                                      } else {
                                        safeSetState(() {});
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update(createUsersRecordData(
                        ...
                        weight: int.tryParse(_model.weightTextController1.text),
                        heartCare:
                            int.tryParse(_model.weightTextController2.text),
                        photoUrl: _model.uploadedFileUrl_profileUploaded,
