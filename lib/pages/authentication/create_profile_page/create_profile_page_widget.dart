...
class _CreateProfilePageWidgetState extends State<CreateProfilePageWidget> {
  ...
  void initState() {
    ...
    _model.weightTextController1 ??= TextEditingController();
    _model.weightFocusNode1 ??= FocusNode();

    _model.weightTextController2 ??= TextEditingController();
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'i2ky9erq' /* Create runner profile */,
                          ),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          controller: _model.weightTextController1,
                          focusNode: _model.weightFocusNode1,
                          textCapitalization: TextCapitalization.words,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              '9vlj86oc' /* Your weight */,
                            ),
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                          ...
                          validator: _model.weightTextController1Validator
                              .asValidator(context),
                          inputFormatters: [
                            if (!isAndroid && !isiOS)
                              TextInputFormatter.withFunction(
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'yz33ax9m' /* resting heart rate (bpm) */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.inter(
                        ...
                        TextFormField(
                          controller: _model.weightTextController2,
                          focusNode: _model.weightFocusNode2,
                          textCapitalization: TextCapitalization.words,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              'zdddocr2' /* Your heatbeat */,
                            ),
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                          ...
                          validator: _model.weightTextController2Validator
                              .asValidator(context),
                          inputFormatters: [
                            if (!isAndroid && !isiOS)
                              TextInputFormatter.withFunction(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await currentUserReference!
                          ...
                          mainActivity: _model.stateValue,
                          bio: _model.myBioTextController.text,
                          gender: _model.genderValue,
                          weight:
                              int.tryParse(_model.weightTextController1.text),
                          heartCare:
                              int.tryParse(_model.weightTextController2.text),
                          photoUrl: _model.uploadedFileUrl_uploadData1mc,
                          birthdate: functions.stringToDateTime(
                              _model.birthdateTextController.text),
                        ));

                        context.pushNamed(CreateProfilDogPageWidget.routeName);
                      },
                      text: FFLocalizations.of(context).getText(
                        'qawos02j' /* Continue and add a dog */,
                      ),
