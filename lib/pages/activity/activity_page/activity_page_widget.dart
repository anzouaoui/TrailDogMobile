...
import '/component/activity/delete_activity_component/delete_activity_component_widget.dart';
        ...
        body: SafeArea(
          ...
          child: StreamBuilder<ActivityRecord>(
            ...
            builder: (context, snapshot) {
              ...
              final stackActivityRecord = snapshot.data!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                stackActivityRecord.activityName,
                                style: FlutterFlowTheme.of(context)
                                    .headlineMedium
                                    .override(
                                      font: GoogleFonts.interTight(
                                ...
                                children: [
                                  ...
                                  Container(
                                    decoration: BoxDecoration(
                                      color: () {
                                        if (stackActivityRecord.activityType ==
                                            'Cani-cross') {
                                          return FlutterFlowTheme.of(context)
                                              .secondary;
                                        } else if ((stackActivityRecord
                                                    .activityType ==
                                                'Cani-randonnée') ||
                                            (stackActivityRecord.activityType ==
                                                'Cani-hicking')) {
                                          return FlutterFlowTheme.of(context)
                                              .primary;
                                        } else {
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          stackActivityRecord.durationSec,
                                          style: FlutterFlowTheme.of(context)
                                              .headlineSmall
                                              .override(
                                                font: GoogleFonts.interTight(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Icon(
                                          Icons.location_on,
                                          color: Color(0xFF1A85FF),
                                          size: 24.0,
                                        ),
                                        Text(
                                          stackActivityRecord.distance
                                              .toString(),
                                          style: FlutterFlowTheme.of(context)
                                              .headlineSmall
                                              .override(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          stackActivityRecord.elevationGain
                                              .toString(),
                                          style: FlutterFlowTheme.of(context)
                                              .headlineSmall
                                              .override(
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final dogs =
                                      stackActivityRecord.dogs.toList();
                                  ...
                                  return Column(
                                    ...
                                    children:
                                      ...
                                      return StreamBuilder<DogRecord>(
                                        stream: DogRecord.getDocument(dogsItem),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                            return Center(
                                          ...
                                          final rowDogRecord = snapshot.data!;
                              ...
                              child: Column(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      RatingBarIndicator(
                                        ...
                                        rating: stackActivityRecord.rate,
                                        unratedColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        itemCount: 5,
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed(
                                        ActivityRatePageWidget.routeName,
                                        queryParameters: {
                                          'activityParameter': serializeParam(
                                            stackActivityRecord.reference,
                                            ParamType.DocumentReference,
