              ...
              children: [
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '705t58az' /* Paramètres de Notification */,
                      ),
                      style:
                ...
                Column(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        'f1umwqrq' /* Catégories de Notifications */,
                      ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'lbxwq6yg' /* Notifications pour nouveaux me... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'gdogoa9t' /* Rappels de vaccination et aler... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'ge5gj5sh' /* Badges, jalons et accomplissem... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'nrbdx63a' /* Interactions Sociales */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'l1jyirwy' /* J'aime, commentaires et mentio... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'slv2f7xx' /* Événements et activités à veni... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'sbd21ajf' /* Recevoir des notifications sur... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'o9lia543' /* Recevoir des résumés et alerte... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'dpakzp4o' /* Couper temporairement toutes l... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                ...
                FFButtonWidget(
                  ...
                  text: FFLocalizations.of(context).getText(
                    'nbky6tk3' /* Sauvegarder les Préférences */,
                  ),
