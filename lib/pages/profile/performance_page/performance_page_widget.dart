...
import 'performance_page_model.dart';
export 'performance_page_model.dart';

class PerformancePageWidget extends StatefulWidget {
  const PerformancePageWidget({super.key});

  static String routeName = 'PerformancePage';
  static String routePath = '/performancePage';

  @override
  State<PerformancePageWidget> createState() => _PerformancePageWidgetState();
}

class _PerformancePageWidgetState extends State<PerformancePageWidget>
    with TickerProviderStateMixin {
  late PerformancePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerformancePageModel());
